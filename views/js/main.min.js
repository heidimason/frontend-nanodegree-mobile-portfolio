...
0;b<document.getElementsByClassName(".randomPizzaContainer").length;b++){var c,d=document.getElementsByClassName(".randomPizzaContainer")[b];c=a;var e=d.offsetWidth,d=document.querySelector("#randomPizzas").offsetWidth,e=e/d,f=void 0;a:{switch(c){case "1":f=.25;break a;case "2":f=.3333;break a;case "3":f=.5;break a;default:console.log("bug in sizeSwitcher")}f=void 0}c=(f-e)*d;c=document.getElementsByClassName(".randomPizzaContainer")[b].offsetWidth+c+"px";document.getElementsByClassName(".randomPizzaContainer")[b].style.width=
