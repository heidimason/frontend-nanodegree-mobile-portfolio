...
c=0,d=b[c].offsetWidth,e=document.querySelector("#randomPizzas").offsetWidth,d=d/e;a:{switch(a){case "1":a=.25;break a;case "2":a=.3333;break a;case "3":a=.5;break a;default:console.log("bug in sizeSwitcher")}a=void 0}e=b[c].offsetWidth+(a-d)*e+"px";for(c=0;c<b.length;c++)b[c].style.width=e;window.performance.mark("mark_end_resize");window.performance.measure("measure_pizza_resize","mark_start_resize","mark_end_resize");b=window.performance.getEntriesByName("measure_pizza_resize");console.log("Time to resize pizzas: "+
b[0].duration+"ms")};window.performance.mark("mark_start_generating");for(var pizzasDiv=document.getElementById("randomPizzas"),i=2;100>i;i++)pizzasDiv.appendChild(pizzaElementGenerator(i));window.performance.mark("mark_end_generating");window.performance.measure("measure_pizza_generation","mark_start_generating","mark_end_generating");var timeToGenerate=window.performance.getEntriesByName("measure_pizza_generation");console.log("Time to generate pizzas on load: "+timeToGenerate[0].duration+"ms");
var frame=0;function logAverageFrame(a){for(var b=a.length,c=0,d=b-1;d>b-11;d--)c+=a[d].duration;console.log("Average time to generate last 10 frames: "+c/10+"ms")}
function updatePositions(){frame++;window.performance.mark("mark_start_frame");for(var a=document.querySelectorAll(".mover"),b=document.body.scrollTop/1250,c=0;c<a.length;c++){var d=Math.sin(b+c%5);a[c].style.left=a[c].basicLeft+100*d+"px"}window.performance.mark("mark_end_frame");window.performance.measure("measure_frame_duration","mark_start_frame","mark_end_frame");0===frame%10&&(a=window.performance.getEntriesByName("measure_frame_duration"),logAverageFrame(a))}
window.addEventListener("scroll",updatePositions);document.addEventListener("DOMContentLoaded",function(){for(var a=0;30>a;a++){var b=document.createElement("img");b.className="mover";b.src="images/pizza.png";b.style.height="100px";b.style.width="73.333px";b.basicLeft=a%8*256;b.style.top=256*Math.floor(a/8)+"px";document.querySelector("#movingPizzas1").appendChild(b)}updatePositions()});