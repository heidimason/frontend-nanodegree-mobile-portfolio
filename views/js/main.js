...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var getrandomPizzaContainer = document.getElementsByClassName("randomPizzaContainer"); // Changing 'querySelectorAll' to 'getElementsByClassName' slightly reduces time to resize pizzas
...
var pizzasDiv = document.getElementById("randomPizzas"); // Moving variable outside loop decreases load time
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
  ...
  var scroll = (document.body.scrollTop / 1250); // Declaring this variable increases fps
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  for (var i = 0; i < 30; i++) { // Creating less pizzas (originally 200) increases fps - it doesn't make sense to create 200 pizzas because a limited number appear on the screen at any given time.
